<!--======================================================
    ...
    Note         : This page defines the Message page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
  ...
  <div class="container">
    ...
    <div class="row mb40">
      ...
      <div class="col-md-6 col-xs-12">
        <h3 class="text-blue">Chairman Message</h3>
          <div class="divider"></div>
        <p class="pt30">
          It is my privilege to welcome you to <strong>Rajiv Memorial Institute of Technology (RMIT)</strong>,
          a premier institution committed to academic excellence, innovation, and holistic development. Since its inception,
          RMIT has endeavored to provide a learning environment that not only imparts knowledge but also fosters critical thinking,
          creativity, and ethical values among students.
        </p>
        <p class="pt15">
          At RMIT, we aim to equip our students with the skills, confidence, and vision required to excel in a rapidly evolving
          technological world. We are dedicated to nurturing future leaders who will make meaningful contributions to society and industry.
        </p>
        <p class="pt20" style="font-style:italic;">
          — Chairman, <strong>RMIT</strong>
        </p>
      </div>
      <!-- Image Column -->
      <div class="col-md-6 col-xs-12 about-video">
        <div class="embed-responsive embed-responsive-16by9">
          <img src="images/chariman.jpg" alt="Chairman" class="img-responsive">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <!-- Text Column -->
      <div class="col-md-6 col-xs-12">
        <h3 class="text-blue">Principal Message</h3>
          <div class="divider"></div>
        <p class="pt30">
          Greetings and a warm welcome to all! At <strong>RMIT</strong>, we aim to provide education that combines academic excellence
          with practical experience, preparing students to meet the challenges of tomorrow. Our dedicated faculty, state-of-the-art
          infrastructure, and student-centered approach ensure that every learner receives the best possible guidance and support.
          We encourage our students to dream big, think innovatively, and pursue excellence in every endeavor.
        </p>
        <p class="pt20" style="font-style:italic;">
          — Principal, <strong>RMIT</strong>
        </p>
      </div>
      <!-- Image Column -->
      <div class="col-md-6 col-xs-12 about-video">
        <div class="embed-responsive embed-responsive-16by9">
          <img src="https://thumbs.dreamstime.com/b/principal-man-wearing-suit-sitting-desk-signboard-front-him-word-written-36068044.jpg"
               alt="Principal" class="img-responsive">
        </div>
      </div>
    </div>
