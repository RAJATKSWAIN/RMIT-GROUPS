<!--======================================================
    File Name   : ElectricalEngg.php
    Project     : RMIT Groups - HIT
    Description : Courses Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Electrical Engineering page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="images/electrical.jpg" alt="ME Logo" loading="lazy" decoding="async"
				style="
				max-height:160px;
				width:100%;
				border-radius:20px;
            ...
            <div class="col-md-12 text-center" style="padding:30px;">
                <div class="row">
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/ele1.png" alt="Mechanical Lab" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px; height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="https://nec.edu.in/wp-content/uploads/2024/02/01-Electrical-Workshop-1.jpg" alt="Workshop Training" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="https://anjumanengg.edu.in/UserData/uploads/pages/1096/lab1.jpg" alt="CAD Design" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-7 col-xs-12 mt60">
        <div class="profile-descr">
            ...
            <div class="profile-title text-left">
                <h2 class="capitalize">Electrical Engineering</h2>                       
                <div style="height: 5px; background: linear-gradient(135deg, #b22222, #8b0000, #ff4500); margin-top: 10px; margin-bottom: 10px; border-radius: 50px; width:50%"></div>
            </div>

            <!-- Profile Details -->
            <div class="profile-details mt30">
                <p>
                    The <strong>Diploma in Electrical Engineering</strong> at HIT builds strong technical foundations in electrical systems, power technologies, and industrial electrical practices. Students are trained to install, operate, and maintain electrical equipment used across industries and infrastructure projects.
                </p>
                <br>
                <p>
                    The program covers <strong>electrical circuits, machines, power systems, control systems, wiring practices, and industrial automation</strong>. With well-equipped laboratories and workshops, students gain hands-on exposure to modern electrical tools and technologies.
                </p>
                <br>
                <p>
                    Diploma holders in Electrical Engineering can work as <strong>Electrical Technicians, Maintenance Engineers, Control Panel Operators, Power Plant Assistants</strong>, or pursue higher studies through <strong>Lateral Entry into B.Tech (Electrical Engineering)</strong> and related programs.
                </p>
                <br>
                ...
                <ul style="margin-top:5px; line-height:1.8; list-style:none; padding-left:0;">
                    <li>⚡ <strong>Educational Qualification:</strong> Successful completion of <strong>10th (Secondary Examination)</strong> or equivalent from a recognized board.</li>
                    ...
                    <li>➡️ <strong>Lateral Entry:</strong> Candidates with <strong>10+2 (Science with PCM)</strong> or an <strong>ITI in Electrical / relevant trade</strong> may be admitted directly into the <strong>second year</strong>.
                    </li>
                </ul>
                <br>
    ...
    <div class="col-md-5 col-xs-12 mt80 text-center">
        <ul class="profile-info" style="list-style:none; padding:20px; margin-top:60px;">
            <li style="margin-bottom:30px;">
                <i class="fa fa-bolt" style="color:#8b0000; font-size:20px; margin-right:15px;"></i>
                <span style="font-size:22px; font-weight:bold;">Branch Details:</span>
                <span style="margin-left:15px;">Diploma in Electrical Engineering</span>
            </li>
            <li>
                ...
                <span style="margin-left:15px;">90 Nos</span>
            </li>
        </ul>
    </div>
    <!-- End of Profile Info -->
