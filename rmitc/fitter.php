<!--======================================================
    File Name   : fitter.php
    Project     : RMIT Groups - RMITC
    Description : Trades Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Fitter Trade page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="/rmitc/images/trades/fitterlogo.png" alt="Trade Logo" loading="lazy" decoding="async"
				style="
				max-height:260px;
				width:60%;
				border-radius:20px;
            ...
            <div class="col-md-6 col-xs-12 mt80">
                <div class="profile-descr">
                    ...
                    <div class="profile-title">
                        <h2 class="capitalize">Fitter Trade (ITI – NCVT)</h2>
                    ...
                    <div class="profile-details mt40">
                        <p> The <strong>Fitter Trade</strong> is a core mechanical trade under the NCVT scheme designed to train students in fitting, assembling, maintaining, and 									repairing mechanical components used in industries.
                        </p>
                        <p> Students gain hands-on experience in measuring, marking, cutting, filing, drilling, tapping, and assembling metal parts with precision. The program 								emphasizes workshop discipline, safety practices, and quality workmanship.
                        </p>
                        <p> After completing the Fitter ITI course, trainees are prepared for technical roles in manufacturing units, maintenance departments, mechanical workshops, and 							 industrial support teams.
                        </p><br>

                        <h3 class="capitalize">ELIGIBILITY CRITERIA</h3>
                        <div style="height:5px; background:linear-gradient(135deg,#00c6ff,#1e90ff,#87cefa); margin:7px 0; border-radius:70px; width:42%"></div>
            ...
            <div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center">
                <ul class="profile-info" style="list-style:none; padding:10px; margin-top:100px;">
                    <li style="margin-bottom:30px;">
                        ...
                        <span style="margin-left:20px;">Fitter (ITI)</span>
                    </li>
                    <li>
