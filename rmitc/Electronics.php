<!--======================================================
    File Name   : Electronics.php
    Project     : RMIT Groups - RMITC
    Description : Trades Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Electronics Trade page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="/rmitc/images/trades/electronics.png" alt="Trade Logo" loading="lazy" decoding="async"
				style="
				max-height:260px;
				width:60%;
				border-radius:20px;
            ...
            <div class="col-md-6 col-xs-12 mt80">
                <div class="profile-descr">
                    ...
                    <div class="profile-title">
                        <h2 class="capitalize">Electronics Trade (ITI – NCVT)</h2>
                    ...
                    <div class="profile-details mt40">
                        <p>
    The <strong>Electronics Trade</strong> is a core technical trade under the NCVT scheme designed to train students in assembling, testing, installing, and maintaining electronic circuits, devices, and systems used in modern industries.
</p>

<p>
    Students gain hands-on experience in soldering, wiring, fault diagnosis, PCB assembly, testing electronic components, and working with digital and analog instruments. The program emphasizes practical skills, safety standards, and systematic troubleshooting methods.
</p>

<p>
    After completing the Electronics ITI course, trainees are prepared for technical roles in electronics manufacturing units, service centers, automation industries, telecom sectors, and industrial maintenance teams.
</p>
<br>
            ...
            <div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center">
                <ul class="profile-info" style="list-style:none; padding:10px; margin-top:100px;">
                    <li style="margin-bottom:30px;">
                        ...
                        <span style="margin-left:20px;">Electronics (ITI)</span>
                    </li>
                    <li>
