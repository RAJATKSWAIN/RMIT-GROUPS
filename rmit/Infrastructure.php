...
<body>
    ...
    <!-- =============== Start of Infrastructure Grid Section =============== -->
        <section class= "ptb40" Style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc); color: #001f4d;">
           <div class="container"  style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc); color: #001f4d; margin-top: 20px;">
              <div class="row text-center">
                  <h2 class="gradient-heading">Modern Infrastructure, Timeless Values</h2>
              ...
              <?php
               $infrastructure = [
                   ["images/Infrastructure/college_campus.jpg", "Campus", "A lush green and eco-friendly campus designed to promote learning and creativity."],
                   ["images/Infrastructure/library.jpg", "Central Library", "Fully equipped library with thousands of volumes, journals, and digital resources."],
                   ["images/Infrastructure/lab.jpg", "Computer Laboratories", "State-of-the-art computer labs with high-speed internet and latest software tools."],
                   ["images/Infrastructure/classroom.jpg", "Smart Classrooms", "Digital learning environment with modern audio-visual teaching aids."],
                   ["images/Infrastructure/auditorium.jpg", "Auditorium", "Spacious and well-equipped auditorium for seminars, events, and cultural programs."],
                   ["images/Infrastructure/sports.jpg", "Sports & Recreation", "Outdoor and indoor sports facilities encouraging students’ overall development."],
                   ["images/Infrastructure/hostel.jpg", "Hostel Accommodation", "Comfortable, safe, and hygienic hostel facilities with Wi-Fi and healthy dining."],
                   ["images/Infrastructure/canteen.jpg", "Cafeteria", "Clean and vibrant canteen offering nutritious and delicious meals at affordable prices."],
                   ["images/Infrastructure/transport1.jpg", "Transport Facility", "Fleet of college buses ensuring safe and convenient transport for students and staff."]
                  ];
