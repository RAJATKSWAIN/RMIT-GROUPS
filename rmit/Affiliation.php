<!--======================================================
    File Name   : Affiliation.php
    Project     : RMIT Groups - RMIT
    Description : Affiliation Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Affiliation page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
    ...
    <!-- =============== Start of Affiliation Grid Section =============== -->
	<section class="search-jobs ptb80" id="version3" style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc); color:#001f4d;">
	<div class="container">
	
		<!-- Section Heading -->
		<div class="text-center mb-5">
			<h2 class="gradient-heading">Institutional Recognition & Academic Affiliation</h2>
		...
		<div class="col-md-12 job-post-main">
			...
			<div class="single-job-post row shadow-hover" style="background:#fff; border-radius:12px; transition:all 0.3s ease;">
				
			<!-- University Logo -->
			<div class="col-md-2 col-xs-3 text-center">
			<div class="job-company">
				<a href="https://buodisha.edu.in/" target="_blank">
				<img src="/rmit/images/Affiliation/bulogo.png" alt="Berhampur University Logo" style="width:45px; height:55px;">
				</a>
				<div class= "row mb-5 text-center" style="margin-top:10px;">
			...
			<div class="col-md-8 col-xs-6 ptb20">
  			<div class="job-title">
    			<h5 style="font-weight:700;">
      				...
      				<span class="affiliation-text">BERHAMPUR UNIVERSITY</span>
      				<span class="affiliation-text">(Accredited with Grade "A" by NAAC)</span>
      				<span class="affiliation-text">RECOGNISED BY GOVT. OF ODISHA.</span>
    			</h5>
  			</div>
			</div>
			...
			<div class="job-category">
				<a href="berhampur-university-affiliation.pdf" target="_blank" class="btn btn-blue btn-small btn-effect">View PDF</a>
			    </div>
			</div>
			</div>
			<!-- ===== End of Single Affiliation Card ===== -->
	...
	<!-- =============== End of Affiliation Grid Section =============== -->
	...
	<!-- ===== Affiliation Styling ===== -->
		...
		.single-job-post:hover .job-title a,
        .single-job-post:hover .job-title span,
		.single-job-post:hover h5,
		.single-job-post:hover p {
				color: #0044cc; /* radiant blue text */
				}
		.btn-blue {
		...
		.btn-blue:hover {
         ...
         /* Default colors */
		.affiliation-text:nth-child(1) { color:#8b0000; }   /* Dark Red */
		.affiliation-text:nth-child(2) { color:#191970; }   /* Dark Blue */
		.affiliation-text:nth-child(3) { color:#000; }      /* Black */

		/* Hover effect */
		.single-job-post:hover .affiliation-text {
  				color:#0044cc; /* Radiant Blue on hover */
				}
