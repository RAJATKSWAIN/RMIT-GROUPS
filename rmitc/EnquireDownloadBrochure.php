...
<section class="search-jobs ptb80" id="enquire-brochure" style="background:linear-gradient(135deg, #e0f7ff, #b3e9fc);">
    <div class="container">
            ...
            <div class="col-md-12 job-post-main">
                ...
                <div class="job-post-wrapper mt20">
					...
					<p class="text-left" style="margin-bottom: 45px; font-size:16px; line-height:1.7;">
    					<strong>Rajiv Memorial Industrial Training Centre (RMITC)</strong> invites aspiring trainees to
    					explore our <strong>industry-oriented trade programs</strong> including
    					<strong>Fitter, Electrician, Electronics Mechanic, and Welder</strong>.
    					Whether you need personalised admission guidance or detailed course information,
    					begin your skill-development journey with us here.
					</p>
                    ...
                    <div class="single-job-post row shadow-hover align-items-center" style ="margin-bottom:45px;">
                        ...
                        <div class="col-md-8 col-xs-6 ">
                            <div class="job-title">
                                <a href="/rmitc/contact.php">
                                    Admission Enquiry – Speak to Our Counsellors
                                </a>
                                <p class="small-text">
    								Get expert guidance on <strong>skill-based trade training programs</strong> including
    								<strong>Fitter, Electrician, Electronics Mechanic, and Welder</strong>.
    								Learn about eligibility, course duration, certification, and career opportunities.
    								Our counsellors are here to help you choose the right trade for a successful technical career.
								</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-xs-3 ptb30 text-center">
                            <div class="job-category">
                                <a href="https://forms.gle/kAotTjMYhsUAd3aE9" class="btn btn-blue btn-small btn-effect">
                                    Enquire Now
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="single-job-post row shadow-hover align-items-center" >
                        ...
                        <!-- Text -->
                        <div class="col-md-8 col-xs-6 " >
                            <div class="job-title" style="margin-top:35px;">
                                <a href="documents/RMIT-Brochure.pdf" target="_blank">
                                    Download College Brochure
                                </a>
                                <!--<p class="small-text">
                                    Discover complete details about RMIT’s <strong>BCA & BES degree programs</strong>,
