<!--======================================================
    File Name   : facilities.php
    Project     : RMIT Groups - RMIT
    Description : Facilities Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Facilities page of RMIT Groups website.
=======================================================-->
...
<body>
	...
	<!-- ===== Start of Facilities Details Section ===== -->
	<section class="facilities-section ptb80" style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc); color: #001f4d;">
	<div class="container">
		<div class="row mb-5 text-center">
		<h2 class="gradient-heading">Facilities that Empower, Spaces that Inspire</h2>
		<p class="lead">At RMIT SmartCampus, infrastructure is more than buildings — it’s the foundation of dreams and discovery.</p>
		...
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Digital Computer Laboratories</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Separate Internet Laboratories</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Fully Furnished Library</h4>
			</a>
		</div>
		...
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Environment-Friendly Classrooms</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Economical Institutional Canteen Facility</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Separate Hostel Facility for Boys and Girls</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Conduct of Regular Seminars</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="https://scholarship.odisha.gov.in/website/home" target="_blank" class="facility-card">
		...
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="https://scholarship.odisha.gov.in/website/home" target="_blank" class="facility-card">
			<h4>Special Facility for SC/ST/OBC</h4>
			</a>
		</div>
			
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Research & Innovation Center</h4>
			</a>
		</div>
	
		<div class="col-lg-4 col-md-6 mb-4">
			<a href="Infrastructure.php" class="facility-card">
			<h4>Career Guidance & Placement Cell</h4>
			</a>
		</div>
		...
		<!-- ===== Facilities Hover Effect Styling ===== -->
		<style>
		.gradient-heading {
				font-weight: 800;
	...
	<!-- ===== End of Facilities Details Section ===== -->
