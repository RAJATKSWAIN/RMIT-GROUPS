<!--======================================================
    File Name   : MechanicalEngg.php
    Project     : RMIT Groups - HIT
    Description : Courses Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Mechanical Engineering page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="images/mechanical.jpg" alt="ME Logo" loading="lazy" decoding="async"
				style="
				max-height:160px;
				width:100%;
				border-radius:20px;
            ...
            <div class="col-md-12 text-center" style="padding:30px;">
                <div class="row">
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/mec1.png" alt="Mechanical Lab" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px; height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/mec2.png" alt="Workshop Training" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/mec3.png" alt="CAD Design" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7 col-xs-12 mt60">
                <div class="profile-descr">
                    ...
                    <div class="profile-title text-left">
                        <h2 class="capitalize">Mechanical Engineering</h2>                       
                    ...
                    <div class="profile-details mt30">
                        <p>
                            The <strong>Diploma in Mechanical Engineering</strong> at HIT provides a solid foundation in core mechanical concepts, industrial practices, and applied 								engineering skills. Students learn to design, analyze, and maintain mechanical systems, preparing them for careers in manufacturing, automotive, energy, and 							allied industries.
                        </p>
                        <br>
                        <p>
                            The program emphasizes <strong>thermodynamics, fluid mechanics, machine design, CAD/CAM, and production technology</strong>. With a blend of theory and 								hands-on workshops, students gain practical exposure to modern tools and industrial processes.
                        </p>
                        <br>
                        <p>
    					Diploma holders in Mechanical Engineering can pursue careers as <strong>Mechanical Technicians, Production Supervisors, CAD Designers, Maintenance 										Engineers</strong>, or continue higher studies through <strong>Lateral Entry into B.Tech (Mechanical Engineering)</strong> and other advanced programs in 								engineering and technology.
						</p>
                        <br>
                        ...
                        <ul style="margin-top:5px; line-height:1.8; list-style:none; padding-left:0;">
                            ...
                            <li>📊 <strong>Minimum Marks:</strong> A minimum aggregate of <strong>35–50%</strong> marks (varies as per HIT norms).</li>
                            ...
                            <li>➡️ <strong>Lateral Entry:</strong> Candidates who have completed <strong>10+2 (Science with PCM)</strong> or an <strong>ITI in relevant trade</strong> 									may be admitted directly into the **second year** of the diploma program, as per HIT guidelines.
                            </li>
            ...
            <div class="col-md-5 col-xs-12 mt80 text-center">
                <ul class="profile-info" style="list-style:none; padding:20px; margin-top:60px;">
                    <li style="margin-bottom:30px;">
                        <i class="fa fa-cogs" style="color:#8b0000; font-size:20px; margin-right:15px;"></i>
                        <span style="font-size:22px; font-weight:bold;">Branch Details:</span>
                        <span style="margin-left:15px;">Diploma in Mechanical Engineering</span>
                    </li>
                    <li>
                        ...
                        <span style="margin-left:15px;">120 Nos</span>
                    </li>
                </ul>
            </div>
            <!-- End of Profile Info -->
