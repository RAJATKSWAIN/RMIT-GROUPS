    ...
    <div class="container">
        ...
        <div class="row ">
            <h2 class="gradient-heading " style= "text-align: center" >
               Access the Official Admission Form — Begin Your Journey at RMIT
			</h2>
            ...
            <div class="col-md-12 job-post-main">
                ...
                <div class="job-post-wrapper mt20">
                    ...
                    <p class="text-left" style="margin-bottom: 45px;font-size:16px;line-height:1.7;">
                        <strong>Rajiv Memorial Institute of Technology (RMIT)</strong> provides
                        easy access to the official <strong>BCA & BES Admission Form</strong>.
                        Download the form below to begin your application process, and submit it
                        as per the instructions to secure your seat.
                    </p>
                        ...
                        <div class="col-md-8 col-xs-6">
                            <div class="job-title">
                                <a href="assets/pdf/AdmissionformRMIT.pdf" target="_blank">
                                    Download Admission Form – BCA & BES
                                </a>
                                <p class="small-text">
                                    Access the official admission form for <strong>BCA & BES programs</strong>,
                                    fill it carefully, and submit along with the required documents to
                                    initiate your admission process at RMIT.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="single-job-post row shadow-hover align-items-center">
                        ...
                        <div class="col-md-8 col-xs-6">
                            <div class="job-title">
                                ...
                                <p class="small-text">
                                    After downloading the form, submit it along with <strong>HSC & +2/Diploma marksheets,
                                    Transfer Certificate, Conduct Certificate, and passport-size photos</strong>
                                    either in person or as per RMIT’s instructions for verification and seat confirmation.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-xs-3 ptb30 text-center">
                            <div class="job-category">
                                <a href="/rmit/contact.php" class="btn btn-blue btn-small btn-effect">
                                    Need Help?
                                </a>
                            </div>
                        </div>
