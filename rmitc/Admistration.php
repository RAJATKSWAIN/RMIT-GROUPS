...
<head>
	...
	<meta name="description" content="Rajiv Memorial Industrial Training Centre (RMITC ITI), Berhampur — A premier ITI institute under RMIT Group of Institutions, offering industry-oriented technical training and skill development in Odisha.">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center" style="margin-bottom:40px;">
                        <p style="font-size:16px; color:#555; line-height:1.8;">👥 Meet the Administrative Team Behind RMITC’s Excellence in Operations and Student Services &nbsp;&nbsp;|| 🏛️ The Backbone of RMITC: Our Dedicated Administrative Leaders &nbsp;&nbsp;|| ⚙️ Guiding RMITC with Precision, Integrity, and Operational Excellence &nbsp;&nbsp;|| 💼 RMITC’s Administrative Department — Empowering Education Through Efficient Leadership &nbsp;&nbsp;|| 🛡️ Our Administrative Pillars: Driving RMITC’s Vision with Commitment and Care </p>
                    </div>
                    <!-- ==== Modified By Rajat Kumar on 29-10-2025 =====-->
