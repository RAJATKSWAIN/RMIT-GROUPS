<!--======================================================
    File Name   : ComputerScienceEngg.php
    Project     : RMIT Groups - HIT
    Description : Courses Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Computer Science Engineering page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="images/computersc.jpg" alt="ME Logo" loading="lazy" decoding="async"
				style="
				max-height:160px;
				width:100%;
				border-radius:20px;
            ...
            <div class="col-md-12 text-center" style="padding:30px;">
                <div class="row">
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/cs1.png" alt="Computer Lab" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px; height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/cs2.png" alt="Workshop Training" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                    <div class="col-md-4 col-xs-12 mb20">
                        <img src="/hit/images/branch/cs3.png" alt="CAD Design" loading="lazy" decoding="async"
                             style="width:100%; border:2px solid #8b0000; border-radius:8px; margin-bottom:5px;  height: 180px">
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-7 col-xs-12 mt60">
        <div class="profile-descr">
            ...
            <div class="profile-title text-left">
                <h2 class="capitalize">Computer Science Engineering</h2>                       
                <div style="height: 5px; background: linear-gradient(135deg, #b22222, #8b0000, #ff4500); margin-top: 10px; margin-bottom: 10px; border-radius: 50px; width:68%"></div>
            </div>

            <!-- Profile Details -->
            <div class="profile-details mt30">
                <p>
                    The <strong>Diploma in Computer Science Engineering</strong> at HIT builds a strong foundation in computing, software development, and digital technologies. Students are trained in programming, system design, and application development to meet the growing demand of the IT industry.
                </p>
                <br>
                <p>
                    The program covers <strong>programming in C/C++ & Python, data structures, database management systems, operating systems, computer networks, web technologies, and software engineering</strong>. With modern computer labs, students gain hands-on experience in coding, testing, and deploying applications.
                </p>
                <br>
                <p>
                    Diploma holders in Computer Science Engineering can work as <strong>Software Developers, Web Developers, System Administrators, Network Technicians, IT Support Engineers</strong>, or pursue higher studies through <strong>Lateral Entry into B.Tech (Computer Science / IT)</strong> and related programs.
                </p>
                <br>
                ...
                <ul style="margin-top:5px; line-height:1.8; list-style:none; padding-left:0;">
                    ...
                    <li>➡️ <strong>Lateral Entry:</strong> Candidates with <strong>10+2 (Science with PCM)</strong> or an <strong>ITI in Computer / IT / relevant trade</strong> may be admitted directly into the <strong>second year</strong>.
                    </li>
                </ul>
                <br>
    ...
    <div class="col-md-5 col-xs-12 mt80 text-center">
        <ul class="profile-info" style="list-style:none; padding:20px; margin-top:60px;">
            <li style="margin-bottom:30px;">
                <i class="fa fa-laptop" style="color:#8b0000; font-size:20px; margin-right:15px;"></i>
                <span style="font-size:22px; font-weight:bold;">Branch Details:</span>
                <span style="margin-left:15px;">Diploma in Computer Science Engineering</span>
            </li>
            <li>
                ...
                <span style="margin-left:15px;">30 Nos</span>
            </li>
        </ul>
    </div>
    <!-- End of Profile Info -->
