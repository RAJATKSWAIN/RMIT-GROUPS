<!--======================================================
    File Name   : Electrician.php
    Project     : RMIT Groups - RMITC
    Description : Trades Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Electrician Trade page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="/rmitc/images/trades/electricianlogo.png" alt="Trade Logo" loading="lazy" decoding="async"
				style="
				max-height:260px;
				width:60%;
				border-radius:20px;
            ...
            <div class="col-md-6 col-xs-12 mt80">
                <div class="profile-descr">
                    ...
                    <div class="profile-title">
                        <h2 class="capitalize">Electrician Trade (ITI – NCVT)</h2>
                        <div style="height:5px; background:linear-gradient(135deg,#00c6ff,#1e90ff,#87cefa); margin:7px 0; border-radius:70px; width:70%"></div>
                    </div>

                    <div class="profile-details mt40">
                        <p> The <strong>Electrician Trade</strong> is a core technical trade under the NCVT scheme designed to train students in the installation, maintenance, and 								repair of electrical wiring systems, machines, and equipment used in residential, commercial, and industrial environments.
						</p>
						<p>Students gain hands-on experience in electrical wiring, panel installation, motor control circuits, transformer basics, earthing systems, and fault detection 							using standard electrical tools and testing instruments. The program emphasizes safety practices, electrical standards, and practical troubleshooting skills.
						</p>
						<p>After completing the Electrician ITI course, trainees are prepared for technical roles in electrical contracting firms, construction projects, manufacturing 							plants, power utilities, and maintenance departments across various industries.
						</p>
						<br>
                        ...
                        <ul style="margin-top:15px; line-height:1.8; list-style:none; padding-left:0;">
                            <li>🎓 <strong>Qualification:</strong> Passed <strong>10th Standard</strong> or equivalent.</li>
                            <li>📘 <strong>Subjects:</strong> Mathematics and Science compulsory.</li>
                            <li>📊 <strong>Minimum Marks:</strong> As per NCVT / State norms.</li>
                            <li>📝 <strong>Admission:</strong> Merit-based or as per ITI admission guidelines.</li>
                        </ul>
            ...
            <div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center">
                <ul class="profile-info" style="list-style:none; padding:10px; margin-top:100px;">
                    <li style="margin-bottom:30px;">
                        ...
                        <span style="margin-left:20px;">Electrician (ITI)</span>
                    </li>
                    <li>
                        ...
                        <span style="margin-left:20px;">90 Nos</span>
                    </li>
                </ul>
            </div>
        </div>
