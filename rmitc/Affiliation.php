				...
				<div class="row text-center">
					...
					<div class="col-md-6 col-xs-6">
						<div class="job-company">
							<img src="/rmitc/images/icons/aictelogo.png" alt="AICTE Logo" style="width:55px; height:55px;">
					...
					<div class="col-md-6 col-xs-6">
						<div class="job-company">
							<img src="/rmitc/images/icons/ncvt-logo.png" alt="SCTE & VT Logo" 
			...
			<div class="col-md-8 col-xs-6 ptb20">
  			<div class="job-title">
    			<h5 style="font-weight:700;">
      				APPROVED & AFFILIATED WITH AICTE, NEW DELHI & NCVT MIS MINISTRY OF SKILL DEVELOPMENT AND ENTREPRENEURSHIP
    			</h5>
				...
				<div class="col-md-2 col-xs-3 ptb30 text-center">
					<div class="row text-center">
					<a href="berhampur-university-affiliation.pdf" target="_blank" class="btn btn-danger btn-effect" style="margin-left:130px;">View PDF</a>
			   		 </div>
				</div>
  			</div>
			</div>
