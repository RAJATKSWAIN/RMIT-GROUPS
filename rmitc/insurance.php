...
<section class="ptb80 insurance-page" id="insurance" style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc);">	
  <div class="container">
    ...
    <div class="text-center mb40">
      ...
      <p class="lead">
        Insurance coverage provided exclusively for incidents occurring within the RMITC campus.
      </p>
    ...
    <div class="row mb40">
      <div class="col-md-12">
        <p>
          Rajiv Memorial Industrial Training Centre (RMITC) provides limited insurance coverage
          to support students in case of accidental injuries or medical emergencies that
          occur strictly <strong>within the RMITC campus premises</strong>.
        </p>
        <p>
    ...
    <div class="row mt40">
      <div class="col-md-6">
        <div class="info-card">
          ...
          <ul>
            <li>Accidental injuries inside RMITC campus</li>
    ...
    <div class="row mt40">
      <div class="col-md-12 ">
        ...
        <p>
          For on-campus insurance support, please contact the RMITC Administration Office
          during working hours.
        </p>
        <a href="contact.php" class="btn btn-blue btn-effect mt20">
