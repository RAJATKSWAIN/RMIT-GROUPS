<!--======================================================
    File Name   : Mission&Vision.php
    Project     : RMIT Groups - RMIT
    Description : Vision & Mission Page 
    Developed By: TrinityWebEdge
    Date Created: 17-12-2025
    Last Updated: <?php echo date("d-m-Y"); ?>
    Note         : This page defines the Mission & VIsion page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<section class="mission-vision ptb80" style="background: linear-gradient(135deg, #e0f7ff, #b3e9fc);">
    <div class="container">
        <div class="text-center mb40" style="margin-top: 20px;">
            ...
            <h2 style= "font-weight: 800; 
						...
						margin-bottom: 15px;">
                Mission & Vision of  RAJIV MEMORIAL INSTITUTE OF TECHNOLOGY 
            </h2>
            
            <!-- Subheadline -->
            <p class="text-center" ><em>"Where knowledge meets responsibility, and learning transforms into leadership."</em></p>
            
            <!-- Radiant blue divider line -->
            <div style="height: 8px; background: linear-gradient(135deg, #00c6ff, #1e90ff, #87cefa); margin: 10px auto; border-radius: 70px; width: 60%;"></div>
        </div>
        
        <!-- Mission -->
		<h3 class="pt30 text-blue" style="font-weight: 700;"> 🎯 Mission</h3>

		<!-- Radiant blue divider line -->
		<div style="height: 5px; background: linear-gradient(135deg, #00c6ff, #1e90ff, #87cefa); margin-top: 07px; margin-bottom: 07px; border-radius: 70px; width: 14%;">
        </div><br>

		<div class="mission-text" style="font-size:16px; line-height:1.8; color:#333;">
    		<p>✨ <strong>Educate students</strong> in Computer Applications and Electronic Sciences, committed to the innovative and ethical application of technology in addressing the 				   most pressing societal needs.</p>
    
    		<p>🌱 <strong>Develop and nurture leadership qualities</strong>, perspectives, and skills in our students, faculty, and alumni to thrive in the twenty-first century.</p>
    
    		<p>💡 <strong>Advance and disseminate transformational knowledge</strong> in computing, electronics, and emerging technologies that contribute to the well-being and 						  sustainability of society.</p>
    
    		<p>🌍 <strong>Provide academic and professional leadership</strong> in enhancing the role and visibility of technology education in shaping youth and influencing public 					 policy.</p>
		</div>

        <!-- Vision -->
        <h3 class="pt30 text-blue" style="font-weight: 700;"> 🌍 Our Vision</h3> 
        
        <!-- Radiant blue divider line -->
		<div style="height: 5px; background: linear-gradient(135deg, #00c6ff, #1e90ff, #87cefa); margin-top: 07px; margin-bottom: 07px; border-radius: 70px; width: 17.5%;">
        </div><br>
        
        <p style="font-size:16px; line-height:1.8; color:#333;">
    		To be recognized as a premier institute serving society by creating knowledge in computer applications and electronic sciences, and by educating graduates for dynamic and 				global careers in technology.
		</p>

		<h5 class="pt20" style="font-weight:700;">Strategic Characteristics and Aspirations</h5><br>

		<div class="vision-points" style="font-size:16px; line-height:1.8; color:#333;">
    		<p>📘 <strong>Contemporary and rigorous educational experiences</strong> that develop the technologist and something more.</p>
    		<p>🤝 <strong>An atmosphere of diversity and community</strong> that fosters personal commitment to student success.</p>
    		<p>🔬 <strong>Academic and research partnerships</strong> with targeted agencies, universities, and industries in computing and electronics.</p>
    		<p>🌟 <strong>Highly successful alumni</strong> who contribute to the profession and society at a global level.</p>
    		<p>💻 <strong>Undergraduate programs (BCA and BES)</strong> that integrate global awareness, communication skills, and teamwork across the curriculum.</p>
    		<p>🚀 <strong>Recognized research and innovation initiatives</strong> in applied computing and electronic sciences.</p>
    		<p>📊 <strong>Prudent and accountable resource management</strong> to sustain growth and excellence.</p>
    		<p>🎓 <strong>Graduate education and training</strong> that prepare students for interdisciplinary research and advanced problem-solving in technology.</p>
    		<p>⚖️ <strong>Leadership and service</strong> that meet society’s needs through innovation, ethics, and responsibility.</p>
		</div>
    </div>
</section>
