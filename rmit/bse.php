<!--======================================================
    ...
    Note         : This page defines the Bachelor in Electronic Science(BES) page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
	...
	<div class="container-fluid" style="padding:0;">
		...
		">
			...
			<img src="/rmit/images/bes.jpg" alt="BCA Logo"
				style="
				max-height:160px;
				width:100%;
				border-radius:20px;
	...
	<!-- ===== Start of Main Wrapper BES Profile Section ===== -->
				...
				<div class="col-md-6 col-xs-12 mt80">
                   <div class="profile-descr">
                       ...
                       <div class="profile-title">
                           <h2 class="capitalize">Bachelor in Electronic Science(BES) </h2>
                           	<div style="height: 5px; background: linear-gradient(135deg, #00c6ff, #1e90ff, #87cefa);  margin-top: 07px; margin-bottom: 07px; border-radius: 70px; 											width:87%">
				</div>
                </div>
						   
				<!-- Profile Details -->
                <div class="profile-details mt40">
                            <p>The <strong>Bachelor in Electronic Science(BES)</strong> is a dynamic undergraduate program that delves into the fascinating world of electronic 											systems and technologies. This discipline bridges the realms of science, engineering, and innovation, focusing on the design, analysis, and 											application of electrical circuits and	devices.</p>
                            <br>
                            <p>Students explore the behavior and functionality of active electronic components such as vacuum tubes, transistors, diodes, and integrated circuits—										building the foundation for modern electronics. From analog systems to digital technologies, the BES program equips learners with both theoretical										knowledge and practical skills essential for careers in electronics, telecommunications, embedded systems, and beyond.</p>
                            <br>
                            <p>Whether you're passionate about circuit design, signal processing, or the future of smart devices, this course opens doors to cutting-edge 												opportunities in research, development, and industry.
                            <p><br>
                            ...
                            <h3 class="capitalize">ELIGIBILITY CRITERIA</h3>
                             ...
                             <p style="margin-top:20px;">Candidates must meet the following requirements:</p>
                             <ul style="margin-top:5px; line-height:1.8; list-style:none; padding-left:0;">
                                <li>
                                    🎓 <strong>Educational Qualification:</strong>
                                    Successful completion of the 10+2 examination or an equivalent qualification from a recognized board.
                                </li>
                                <li>
                                    📘 <strong>Core Subjects:</strong>
                                    Physics, Chemistry, and Mathematics (PCM) must be among the compulsory subjects.
                                </li>
                                <li>
                                    🗣️ <strong>Language Requirement:</strong>
                                    English is also a compulsory subject at the 10+2 level.
                                </li>
                                <li>
                                    📊 <strong>Minimum Marks:</strong>
                                    A minimum of 45% aggregate marks is required in the 10+2 examination. Reserved category candidates may receive a	5% relaxation as per institutional norms.
                                </li>
                                <li>
				...
				<div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center">
					<ul class="profile-info" style="list-style:none; padding:10px; margin-top:100px;">
						<li style="margin-bottom:30px;">
							...
							<span style="margin-left:20px;">Bachelor in Electronics Science</span>
						</li>
						<li>
				...
				<div class="col-md-4 col-md-offset-2 col-xs-12 mt80 text-center" style="margin-top:100px; padding:30px;">
					<div class="row">
						<div class="col-xs-12 mb20">
							<img src="images/branch/bes_1.jpg" alt="BES Course Overview" loading="lazy" decoding="async"
                                 style="width:100%; border:2px solid #0056b3; border-radius:8px; margin-bottom:30px;">
						</div>
						<div class="col-xs-12 mb20">
							<img src="images/branch/bse_2.jpg" alt="BES Career Paths" loading="lazy" decoding="async"
                                 style="width:100%; border:2px solid #0056b3; border-radius:8px; margin-bottom:30px;">
						</div>
						<div class="col-xs-12 mb20">
							<img src="images/branch/bes_4.png" alt="BES Career Paths" loading="lazy" decoding="async"
	...
	<!--===== Strat CSS for BES Profile Section =====-->
		<style>
	...
	<!--===== End CSS for BES Profile Section =====-->
