<!--======================================================
    ...
    Note         : This page defines the Career page of RMIT Groups website.
=======================================================-->
<!DOCTYPE html>
...
<body>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-xs-12">
					<h2 class="gradient-heading">Careers at RMIT</h2>
					...
					<p class="pt20 lead">
						<strong>Begin your professional journey with RMIT</strong> and unlock opportunities that empower your skills, knowledge, and passion for technology and 									innovation.
					</p>
	
					<p class="pt20">
						At RMIT, we guide students towards successful careers through <strong>industry-focused education</strong>, <strong>practical learning</strong>, and 									<strong>continuous mentorship</strong>. 
						Our dedicated Career Development Cell ensures that every student is prepared to step confidently into the professional world.
					</p>
	
					<ul class="pt20 list-unstyled">
						<li><i class="fa fa-check-circle text-blue"></i> Resume-building workshops & interview preparation</li><br>
						<li><i class="fa fa-check-circle text-blue"></i> Internship opportunities with reputed organizations</li><br>
						<li><i class="fa fa-check-circle text-blue"></i> Campus recruitment drives with top industry partners</li><br>
						<li><i class="fa fa-check-circle text-blue"></i> Ongoing mentorship for career growth</li>
					</ul>
	
					<p class="pt30 text-danger">
						<strong>Important Notice:</strong> RMIT does not charge any fees for career guidance or placement assistance. 
						If you receive any fraudulent communication requesting payment, kindly ignore it and report the matter to us immediately.
					</p>
	
					<!-- Contact Button -->
					<a href="contact.php" class="btn btn-blue btn-effect mt30">
						<i class="fa fa-envelope"></i> Contact Career Team
					</a>
				</div>
				...
				<div class="col-md-6 col-xs-12 about-video">
					<div class="item d-flex justify-content-center">
						<img src="https://www.southpointfinancial.com/wp-content/uploads/2023/12/5-Career-Goals.jpg" 
							class="img-responsive" 
							alt="RMIT Career Guidance"
							style="height: 635px;
									max-width: 100%;
									width: auto;
									object-fit: cover;
	...
	<!-- =============== Start of Recruiting Companies CTA =============== -->
	<section class="get-started ptb40" style="background: linear-gradient(90deg, #0044cc, #00aaff);">
		<div class="container">
			<div class="row align-items-center">
	
				<div class="col-md-10 col-sm-9 col-xs-12">
					<h3 class="text-white">Our Recruiting Partners</h3>
					<p class="text-white mt10">
						Explore the companies that actively recruit RMIT students
						across IT and Electronics domains.
					</p>
				</div>
	
				<div class="col-md-2 col-sm-3 col-xs-12 text-right">
					<a href="recrutingcompanies.php" class="btn btn-blue btn-effect">
						View Recruiters
					</a>
				</div>
	...
	<!-- =============== End of Recruiting Companies CTA =============== -->
